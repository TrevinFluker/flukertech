...
// Wordwich-specific leaderboard key
const WW_LEADERBOARD_KEY = "wwGameLeaderboard";

// --- Leaderboard data helpers ---
function getLeaderboard() {
    try {
      return JSON.parse(localStorage.getItem(WW_LEADERBOARD_KEY) || "{}");
    } catch (e) {
      return {};
    }
  }
  ...
  function updateLeaderboard(userScores) {
    ...
    localStorage.setItem(WW_LEADERBOARD_KEY, JSON.stringify(leaderboard));
    return leaderboard;
  }
